            ...
            <div class="w-full rounded overflow-hidden shadow-lg px-6 py-6 bg-white">
                <div class="flex flex-wrap -mx-4 -mb-4 md:mb-0">
                    <div class="w-full md:w-1/6 px-4 mb-4 md:mb-0">
                        <img src="{{ $item->food->picturePath }}" alt="" class="rounded">
                    </div>
                        ...
                        <div class="flex flex-wrap mb-3">
                            ...
                            <div class="w-1/6">
                                ...
                                <a href="{{ route('transactions.changeStatus', ['id' => $item->id, 'status' => 'ON_DELIVERY']) }}"
                                   class="bg-green-500 hover:bg-blue-700 text-black font-bold px-2 rounded block text-center w-full mb-1">
                                    On Delivery
                                </a>
                                ...
                                <a href="{{ route('transactions.changeStatus', ['id' => $item->id, 'status' => 'CANCELLED']) }}"
                                   class="bg-green-500 hover:bg-red-700 text-black font-bold px-2 rounded block text-center w-full mb-1">
                                    Cancelled
                                </a>
                            </div>
                        </div>
